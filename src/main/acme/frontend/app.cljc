(ns ^:dev/always acme.frontend.app
  (:require
   ...
   [reacl-c.interop.react :as interop.react]
...
(c/def-item jazz-and-auth
  (c/fragment
   (interop.react/lift jazz/JazzProvider)
   (interop.react/lift jazz/DemoAuthBasic {:appName "Circular" :state authState})))
